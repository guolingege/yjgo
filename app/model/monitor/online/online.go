...
func SelectListExport(param *SelectPageReq) (gdb.Result, error) {
	...
	model.Fields(" t.sessionId ,t.login_name ,t.dept_name ,t.ipaddr ,t.login_location ,t.browser ,t.os ,t.status ,t.start_timestamp ,t.last_access_time ,t.expire_time")
